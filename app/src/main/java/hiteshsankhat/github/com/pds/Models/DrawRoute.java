...
public class DrawRoute {
	...
	public static String getUrl(LatLng start, LatLng end, GoogleMap googleMap, String key){
		mMap = googleMap;
		String str_start = "origin="+start.latitude+","+start.longitude;
		String str_end = "destination="+end.latitude+","+end.longitude;
		String sensor = "sensor=false";
		String keyApi = "key=AIzaSyD33YrCze7dw2UPyn0NrJno9ecr1Tgdau0";
		Log.d(TAG, "getUrl: "+ key);
